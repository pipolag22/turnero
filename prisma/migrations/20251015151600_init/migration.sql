-- CreateEnum
CREATE TYPE "public"."Role" AS ENUM ('ADMIN', 'BOX_AGENT', 'PSYCHO_AGENT', 'CASHIER_AGENT');

-- CreateEnum
CREATE TYPE "public"."TicketStatus" AS ENUM ('EN_COLA', 'EN_ATENCION', 'DERIVADO', 'FINALIZADO', 'CANCELADO');

-- CreateEnum
CREATE TYPE "public"."TicketStage" AS ENUM ('RECEPCION', 'BOX', 'PSICO', 'FINAL', 'CAJERO');
...
CREATE TABLE "public"."SystemStatus" (
    ...
    "alertaEnabled" BOOLEAN NOT NULL DEFAULT false,
    "alertaText" TEXT NOT NULL DEFAULT '',
    "teoricoStatus" TEXT NOT NULL DEFAULT 'INACTIVO',
    "practicoStatus" TEXT NOT NULL DEFAULT 'NINGUNA',
    "updatedAt" TIMESTAMP(3) NOT NULL,
